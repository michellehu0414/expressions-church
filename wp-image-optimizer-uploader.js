...
const inputFolder = './images/wp/queue'; // Folder with original images
const webpFolder = './images/wp/webp'; // Folder for WebP images
const compressedFolder = './images/wp/compressed'; // Folder for processed images
const originalsFolder = './images/wp/originals'; // Folder for original images
