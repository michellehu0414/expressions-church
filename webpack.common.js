...
module.exports = {
	entry: {
		...
		buttonStyles: "./src/components/Button/Button.scss",
		main: "./src/main.js"
	},
	...
	module: {
		rules: [
			...
			{
				test: /\.(mp4|webm|ogg)$/i, // Add support for video formats
				type: "asset/resource",
				generator: {
					filename: "assets/videos/[name][ext]" // Output videos to the "assets/videos" folder
				}
			}
		]
	},
